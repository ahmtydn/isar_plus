...
class IsarCoreBindings {
  ...
  late final _isar_insert_savePtr = _lookup<
    ffi.NativeFunction<ffi.Uint8 Function(ffi.Pointer<CIsarWriter>, ffi.Int64)>
  >('isar_insert_save');
  ...
  late final _isar_closePtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<CIsarInstance>, ffi.Bool)>
  >('isar_close');
  ...
  late final _isar_read_nullPtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<CIsarReader>, ffi.Uint32)>
  >('isar_read_null');
  ...
  late final _isar_read_longPtr = _lookup<
    ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<CIsarReader>, ffi.Uint32)>
  >('isar_read_long');
  ...
  late final _isar_watch_collection_detailedPtr = _lookup<
    ffi.NativeFunction<
      ffi.Uint8 Function(
        ffi.Pointer<CIsarInstance>,
        ffi.Uint16,
