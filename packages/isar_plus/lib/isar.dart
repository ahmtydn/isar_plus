...
import 'package:isar_plus/src/native/isar_core.dart'
    if (dart.library.html) 'package:isar_plus/src/web/isar_web.dart';
import 'package:isar_plus/src/native/isar_link_impl.dart'
    if (dart.library.html) 'package:isar_plus/src/web/isar_link_impl.dart';
import 'package:isar_plus/src/native/open.dart'
    if (dart.library.html) 'package:isar_plus/src/web/open.dart';
import 'package:isar_plus/src/native/split_words.dart'
    if (dart.library.html) 'package:isar_plus/src/web/split_words.dart';
