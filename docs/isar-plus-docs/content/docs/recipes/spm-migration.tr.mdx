---
title: SPM Geçişi
description: isar_plus_flutter_libs'in CocoaPods'tan Swift Package Manager'a geçişi ve birleşik Darwin yapısı
icon: Package
---
...
iOS proje dizininizdeki `Podfile` ve `Podfile.lock` dosyalarını silin, `Pods/` dizinini kaldırın:
