...
| `directory`         | The storage location for this instance. On Flutter Web it maps to a folder inside OPFS/IndexedDB (for example `isar_data`). Use `Isar.sqliteInMemory` when you intentionally want a transient database.                                                                                       |
