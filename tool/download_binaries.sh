...
curl "${github}/isar_ios.xcframework.zip" -o packages/isar_plus_flutter_libs/ios/isar_ios.xcframework.zip --create-dirs -L -f
...
curl "${github}/libisar_macos.dylib" -o packages/isar_plus_flutter_libs/macos/libisar.dylib --create-dirs -L -f
